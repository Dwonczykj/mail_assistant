...
// Register GmailAuthForDaemon as the IGoogleAuth implementation for dependency injection.
container.register<IGoogleAuth>('IGoogleAuth', { useClass: GoogleAuthForDaemon });
